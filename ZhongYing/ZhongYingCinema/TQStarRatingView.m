...
- (id)initWithFrame:(CGRect)frame numberOfStar:(int)number
{
    ...
    if (self) {
        ...
        self.starBackgroundView = [self buidlStarViewWithImageName:@"cinema_not_concern"];
        self.starForegroundView = [self buidlStarViewWithImageName:@"cinema_concern"];
...
- (UIView *)buidlStarViewWithImageName:(NSString *)imageName
{
    ...
    for (int i = 0; i < self.numberOfStar; i ++)
    {
        ...
        imageView.frame = CGRectMake(i * ((frame.size.width - 60) / self.numberOfStar  +15), 0, (frame.size.width -60) / self.numberOfStar, frame.size.height);
