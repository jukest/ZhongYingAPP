...
#define FULL_SCREEN 1
    ...
    UIBarButtonItem *eventItem = [[UIBarButtonItem alloc] initWithTitle:@"节假日" style:UIBarButtonItemStylePlain target:self action:@selector(eventItemClicked:)];
...
- (void)calendar:(FSCalendar *)calendar didSelectDate:(NSDate *)date atMonthPosition:(FSCalendarMonthPosition)monthPosition
{
    ...
    if (self.selectedCalenderBlock) {
        self.selectedCalenderBlock(calendar,date,[self.dateFormatter stringFromDate:date]);
