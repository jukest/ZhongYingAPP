...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _tabView = [[LHTabView alloc]initWithItemsName:@[@"正在热映",@"即将上映"]  childrenView:@[mainView,weiboView] withTableView:NO withHasNavigationBar:YES]; // [[LHTabView alloc]initWithItemsName:@[@"正在热映",@"即将上映"] childrenView:@[mainView,weiboView] withTableView:NO];
