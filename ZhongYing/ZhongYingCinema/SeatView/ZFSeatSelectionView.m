...
-(void)startAnimation{
    NSLog(@"ZFseastNomarW_H / self.seatView.seatBtnHeight = %f",ZFseastNomarW_H / self.seatView.seatBtnHeight);
    [UIView animateWithDuration:0.5 delay:0.2 options:UIViewAnimationOptionCurveEaseOut animations:^{
        ...
        CGRect zoomRect = self.seatView.frame;
        zoomRect.origin.y -= 30;
        zoomRect.size.height += 30;
